...
class TestWebToolPolicy:
    """Tests that exercise extraction/provider website-policy gates.
    ...
    @pytest.mark.asyncio
    async def test_firecrawl_provider_blocks_redirected_final_url(self, monkeypatch):
        from plugins.web.firecrawl import provider as firecrawl_provider
        ...
        result = await provider.crawl("https://allowed.test")
