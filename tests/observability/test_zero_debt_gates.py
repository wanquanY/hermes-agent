...
def test_p2_inventory_reports_current_offender_baseline() -> None:
    ...
    assert gates["p2:no_sessiondb_production"]["total_offenders"] == 135
    assert gates["p2:no_sessiondb_production"]["file_count"] == 40
    assert gates["p2:no_legacy_identity_alias_internal"]["total_offenders"] == 1199
