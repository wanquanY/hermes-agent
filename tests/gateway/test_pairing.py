...
from hermes_gateway.pairing import (
    PairingStore,
    ALPHABET,
    CODE_LENGTH,
    CODE_TTL_SECONDS,
...
def _make_store(tmp_path):
    ...
    with patch("hermes_gateway.pairing.PAIRING_DIR", tmp_path):
        return PairingStore()
...
class TestCodeGeneration:
    ...
    def test_stores_pending_entry(self, tmp_path):
        ...
        assert pending[0]["code"] == hashlib.sha256(code.encode("utf-8")).hexdigest()[:8]
