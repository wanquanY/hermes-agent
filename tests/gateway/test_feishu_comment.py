...
from channels.platforms.feishu_comment import (
...
class TestEventFiltering(unittest.TestCase):
    ...
    @patch("channels.platforms.feishu_comment_rules.load_config")
    @patch("channels.platforms.feishu_comment_rules.resolve_rule")
    @patch("channels.platforms.feishu_comment_rules.is_user_allowed")
...
class TestAccessControlIntegration(unittest.TestCase):
    ...
    @patch("channels.platforms.feishu_comment_rules.has_wiki_keys", return_value=False)
    @patch("channels.platforms.feishu_comment_rules.is_user_allowed", return_value=False)
    @patch("channels.platforms.feishu_comment_rules.resolve_rule")
    @patch("channels.platforms.feishu_comment_rules.load_config")
...
class TestWikiReverseLookup(unittest.TestCase):
    ...
    @patch("channels.platforms.feishu_comment._exec_request")
    def test_reverse_lookup_success(self, mock_exec):
        from channels.platforms.feishu_comment import _reverse_lookup_wiki_token
    ...
    @patch("channels.platforms.feishu_comment._reverse_lookup_wiki_token", new_callable=AsyncMock)
    @patch("channels.platforms.feishu_comment_rules.has_wiki_keys", return_value=True)
    @patch("channels.platforms.feishu_comment_rules.is_user_allowed", return_value=True)
    @patch("channels.platforms.feishu_comment_rules.resolve_rule")
    @patch("channels.platforms.feishu_comment_rules.load_config")
    @patch("channels.platforms.feishu_comment.add_comment_reaction", new_callable=AsyncMock)
    @patch("channels.platforms.feishu_comment.batch_query_comment", new_callable=AsyncMock)
    @patch("channels.platforms.feishu_comment.query_document_meta", new_callable=AsyncMock)
