...
- channels/platforms/mattermost.py: MattermostAdapter._send_url_as_file
...
class TestCacheImageFromBytes:
    """Tests for channels.platforms.base.cache_image_from_bytes"""

    def test_caches_valid_jpeg(self, tmp_path, monkeypatch):
        monkeypatch.setattr("channels.platforms.base.IMAGE_CACHE_DIR", tmp_path / "img")
...
class TestCacheImageFromUrl:
    """Tests for channels.platforms.base.cache_image_from_url"""
    ...
    def test_success_on_first_attempt(self, _mock_safe, tmp_path, monkeypatch):
        ...
        async def run():
            with patch("httpx.AsyncClient", return_value=mock_client):
                from channels.platforms.base import cache_image_from_url
...
class TestCacheAudioFromUrl:
    """Tests for channels.platforms.base.cache_audio_from_url"""

    def test_success_on_first_attempt(self, _mock_safe, tmp_path, monkeypatch):
        """A clean 200 response caches the audio and returns a path."""
        monkeypatch.setattr("channels.platforms.base.AUDIO_CACHE_DIR", tmp_path / "audio")
        ...
        async def run():
            with patch("httpx.AsyncClient", return_value=mock_client):
                from channels.platforms.base import cache_audio_from_url
...
from hermes_gateway.config import Platform, PlatformConfig  # noqa: E402
