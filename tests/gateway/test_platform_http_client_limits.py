...
def test_returns_none_when_httpx_unavailable(monkeypatch):
    ...
    import channels.platforms._http_client_limits as mod
...
def test_helper_is_importable_from_every_platform_that_uses_it():
    ...
    import channels.platforms.qqbot.adapter  # noqa: F401
    import channels.platforms.wecom  # noqa: F401
    import channels.platforms.dingtalk  # noqa: F401
    import channels.platforms.signal  # noqa: F401
    import channels.platforms.bluebubbles  # noqa: F401
    import channels.platforms.wecom_callback  # noqa: F401
...
class TestWhatsappTypingLeakFix:
    ...
    def test_bare_await_removed(self):
        import inspect
        import channels.platforms.whatsapp as mod
