...
def _fake_dingtalk_optional_sdks(monkeypatch):
    ...
    from channels.platforms import dingtalk as dt
...
class TestDingTalkRequirements:
    ...
    def test_returns_false_when_sdk_missing(self, monkeypatch):
        with patch.dict("sys.modules", {"dingtalk_stream": None}), \
            ...
            monkeypatch.setattr(
                "channels.platforms.dingtalk.DINGTALK_STREAM_AVAILABLE", False
            )
    ...
    def test_returns_false_when_env_vars_missing(self, monkeypatch):
        monkeypatch.setattr(
            "channels.platforms.dingtalk.DINGTALK_STREAM_AVAILABLE", True
        )
        monkeypatch.setattr("channels.platforms.dingtalk.HTTPX_AVAILABLE", True)
...
class TestHandlerProcessIsAsync:
    ...
    def test_process_is_coroutine_function(self):
        from channels.platforms.dingtalk import _IncomingHandler
...
class TestExtractMedia:
    ...
    def test_audio_rich_text_item_stays_audio(self):
        ...
        from channels.platforms.dingtalk import DingTalkAdapter, DINGTALK_TYPE_MAPPING
        from channels.platforms.base import MessageType
...
class TestIncomingHandlerProcess:
    ...
    async def test_process_extracts_session_webhook(self):
        ...
        from channels.platforms.dingtalk import _IncomingHandler, DingTalkAdapter
