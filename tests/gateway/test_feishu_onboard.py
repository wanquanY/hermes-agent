"""Tests for channels.platforms.feishu — Feishu scan-to-create registration."""
...
class TestPostRegistration:
    ...
    @patch("channels.platforms.feishu.urlopen")
    def test_post_registration_returns_parsed_json(self, mock_urlopen_fn):
        from channels.platforms.feishu import _post_registration
...
class TestInitRegistration:
    ...
    def test_init_succeeds_when_client_secret_supported(self, mock_urlopen_fn):
        from channels.platforms.feishu import _init_registration
...
class TestBeginRegistration:
    ...
    def test_begin_returns_device_code_and_qr_url(self, mock_urlopen_fn):
        from channels.platforms.feishu import _begin_registration
...
class TestPollRegistration:
    ...
    @patch("channels.platforms.feishu.time")
    @patch("channels.platforms.feishu.urlopen")
    def test_poll_returns_credentials_on_success(self, mock_urlopen_fn, mock_time):
        from channels.platforms.feishu import _poll_registration
...
class TestRenderQr:
    ...
    @patch("channels.platforms.feishu._qrcode_mod", create=True)
    def test_render_qr_returns_true_on_success(self, mock_qrcode_mod):
        from channels.platforms.feishu import _render_qr
    ...
    def test_render_qr_returns_false_when_qrcode_missing(self):
        ...
        with patch("channels.platforms.feishu._qrcode_mod", None):
...
class TestProbeBot:
    ...
    def test_probe_returns_bot_info_on_success(self):
        ...
        with patch("channels.platforms.feishu._probe_bot_sdk") as mock_sdk:
    ...
    @patch("channels.platforms.feishu.FEISHU_AVAILABLE", False)
    @patch("channels.platforms.feishu.urlopen")
...
class TestQrRegister:
    ...
    @patch("channels.platforms.feishu.probe_bot")
    @patch("channels.platforms.feishu._render_qr")
    @patch("channels.platforms.feishu._poll_registration")
    @patch("channels.platforms.feishu._begin_registration")
    @patch("channels.platforms.feishu._init_registration")
