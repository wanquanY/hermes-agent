...
from hermes_gateway.runner import GatewayRunner  # noqa: E402
from hermes_gateway.platform_runtime import platform_runtime_for  # noqa: E402
...
async def test_liveness_fatal_queues_primary_runner_reconnect_without_self_cancellation(monkeypatch):
    ...
    adapter.set_fatal_error_handler(
        platform_runtime_for(runner).handle_adapter_fatal_error
    )
    await _connect(adapter, monkeypatch, factory)
