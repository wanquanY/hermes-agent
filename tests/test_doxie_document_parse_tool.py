...
import doxie_extension.document_parse_tool as document_parse_tool
from doxie_extension.document_parse_tool import parse_document_tool
from doxie_extension.prompt_attachments import (
