...
class TestGatewayRunnerRegistration:
    ...
    def test_runner_creates_yuanbao_adapter(self):
        ...
        try:
            ...
            with patch("channels.platforms.yuanbao.WEBSOCKETS_AVAILABLE", True):
...
class TestProtoRoundTrip:
    ...
    def test_conn_msg_roundtrip(self):
        from channels.platforms.yuanbao_proto import encode_conn_msg, decode_conn_msg
    ...
    def test_text_elem_encoding(self):
        from channels.platforms.yuanbao_proto import encode_send_c2c_message
...
class TestSignToken:
    def test_import_ok(self):
        from channels.platforms.yuanbao import SignManager
...
class TestManagerImports:
    ...
    def test_outbound_composes_sub_managers(self):
        adapter = YuanbaoAdapter(make_config())
        from channels.platforms.yuanbao import MessageSender, HeartbeatManager, SlowResponseNotifier
...
class TestMediaModule:
    def test_import_ok(self):
        from channels.platforms.yuanbao_media import upload_to_cos, download_url
...
class TestPlatformInit:
    def test_yuanbao_adapter_exported(self):
        ...
        from channels.platforms import YuanbaoAdapter as _YuanbaoAdapter
