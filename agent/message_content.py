"""Canonical text extraction for provider message content shapes."""
...
def flatten_message_text(content: Any, *, sep: str = "\n") -> str:
    """Return visible text from common Chat Completions/Responses shapes."""
    if content is None:
        return ""
