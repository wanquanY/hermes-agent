"""Feishu/Lark QR onboarding and bot probe helpers."""
...
FEISHU_DOMAIN = getattr(lark, "FEISHU_DOMAIN", "https://open.feishu.cn") if lark is not None else "https://open.feishu.cn"
LARK_DOMAIN = getattr(lark, "LARK_DOMAIN", "https://open.larksuite.com") if lark is not None else "https://open.larksuite.com"
FEISHU_AVAILABLE = lark is not None

_REGISTRATION_PATH = "/open-apis/bot/v3/registration"
_ONBOARD_REQUEST_TIMEOUT_S = 20
