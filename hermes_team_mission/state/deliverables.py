...
DELIVERABLE_VALID_SOURCES = frozenset(
    {
        DELIVERABLE_SOURCE_AUTHORITATIVE,
        DELIVERABLE_SOURCE_DERIVED_DEGRADED,
        DELIVERABLE_SOURCE_LEGACY_IMPORTED,
        DELIVERABLE_SOURCE_MISSING,
    }
)
DELIVERABLE_EFFECTIVE_SOURCES = frozenset(
    {
        DELIVERABLE_SOURCE_AUTHORITATIVE,
        DELIVERABLE_SOURCE_DERIVED_DEGRADED,
        DELIVERABLE_SOURCE_LEGACY_IMPORTED,
...
def _normalize_source(value: Any) -> str:
    ...
    if normalized in DELIVERABLE_VALID_SOURCES:
        return normalized
    return DELIVERABLE_SOURCE_AUTHORITATIVE
...
def team_mission_run_has_deliverable(db: Any, run_id: str) -> bool:
    deliverable = latest_team_mission_deliverable_for_run(db, run_id)
    if not deliverable:
        return False
    return text(deliverable.get("source")) in DELIVERABLE_EFFECTIVE_SOURCES
