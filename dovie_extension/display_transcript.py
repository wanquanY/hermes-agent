"""Dovie-facing transcript display normalization.
...
def sanitize_transcript_message(message: Mapping[str, Any]) -> dict[str, Any] | None:
    """Return a Dovie-display copy of a transcript message.
...
def sanitize_session_list_item(session: Mapping[str, Any]) -> dict[str, Any]:
    """Normalize session list title/preview for Dovie history surfaces."""
