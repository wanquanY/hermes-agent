...
class MemberChatProjectionService:
    ...
    def _message_repo(self, conn: sqlite3.Connection | None = None) -> MessageRepoImpl:
        return MessageRepoImpl(conn or self._conn)
    ...
    def sync_member_chat_conversation_view(
        ...
        *,
        ...
        source_messages = self._get_messages(conversation_session_id) or []
        own_messages = self._get_messages(member_chat_session_id) or []
