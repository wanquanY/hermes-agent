...
class HermesStateStore(AgentProfileStateMixin, TeamRegistryStateMixin, TeamCapabilityStateMixin, TeamMissionStateMixin, MemberChatStateMixin, ParticipantsMixin, ActivitiesMixin, RunStateMixin, BranchStateMixin, TelegramTopicStateMixin):
    """
