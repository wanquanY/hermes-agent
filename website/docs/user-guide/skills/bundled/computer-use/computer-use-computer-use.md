---
title: "Computer Use — Drive desktop apps without stealing the user's input"
sidebar_label: "Computer Use"
description: "Drive desktop apps without stealing the user's input"
---
...
Drive desktop apps without stealing the user's input.
