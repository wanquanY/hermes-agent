...
## Phases 7-8: Submission and Publication

**Goal**: Validate the final artifact, meet venue requirements, package reproducibility materials, and prepare post-acceptance deliverables.

Load [references/submission-and-publication.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/research/research-paper-writing/references/submission-and-publication.md) before:
- final compilation, anonymization, or venue-format conversion;
- camera-ready, arXiv, code-release, poster, talk, or launch work;
- adapting the pipeline to workshop, short, theory, survey, benchmark, or position papers.

Keep the same evidence and citation standards from Phases 0-6. Never submit, publish, or de-anonymize without the user's explicit approval.
