"""Resume-pending marker decisions for gateway turns."""

from __future__ import annotations


def should_clear_resume_pending_after_turn(agent_result: dict) -> bool:
...
def preserve_queued_followup_history_offset(
    current_result: dict,
